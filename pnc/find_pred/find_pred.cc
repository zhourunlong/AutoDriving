...
int main() {
  ...
  file::ReadTextFileToProto("/home/vectorzhou/AutoDriving/pnc/map/grid3/map_proto.txt", &map);
  ...
  file::WriteProtoToTextFile(ret, "/home/vectorzhou/AutoDriving/pnc/find_pred/processed_map_proto.txt");
  return 0;
}
